...
**Dashboard build**
- See `dashboard-spec.md` for the first-pass PostHog nurture dashboard setup.
...
- For Brevo config and template examples, see `brevo-setup.md`.
