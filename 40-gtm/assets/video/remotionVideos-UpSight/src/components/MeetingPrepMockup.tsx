...
/**
 * Animated meeting-prep dashboard for homepage hero.
 * Shows scorecard, evidence-backed issues, and owned action items.
 */
export const MeetingPrepMockup: React.FC<{ delay?: number }> = ({
  ...
  const shellOpacity = shellProgress;
  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${isAttention ? "rgba(245, 158, 11, 0.25)" : "rgba(56, 189, 248, 0.1)"}`,
      }}
    >
      <div
        style={{
