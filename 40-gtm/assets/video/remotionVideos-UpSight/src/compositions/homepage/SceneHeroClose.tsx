...
/**
 * Scene 4 — Brand close with tagline and CTA.
 */
export const SceneHeroClose: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Img src={staticFile("upsight-logo.png")} style={{ height: 88 }} />
      </div>
      ...
      >
        <span style={{ color: colors.textLight }}>Get your customers.</span>
        <br />
        <span style={{ color: colors.amber }}>Build conviction.</span>
      </div>
