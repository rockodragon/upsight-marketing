...
| Asset | Location |
|-------|----------|
| Landing page (dark, dev-focused) | `40-gtm/assets/landing/agentcrm-landing.html` |
| Pricing strategy | `30-strategy/pricing-strategy.md` |
| Keyword research (15 keywords) | `20-research/market-intel/Keyword-Research/agentcrm-keyword-research.md` |
| OpenClaw distribution strategy | `mcp-servers/agent-crm/docs/OPENCLAW-STRATEGY.md` |
| Docs platform evaluation (Mintlify) | `30-strategy/docs-platform-evaluation.md` |
...
| `30-strategy/pricing-strategy.md` | Full pricing analysis with competitive benchmarks | Active (companion) |
| `30-strategy/brand-brief.md` | Canonical UpSight positioning (v3.1) | Active (parent doc) |
| `30-strategy/positioning-brief.md` | Tactical messaging, objection handling | Active (companion) |
| `30-strategy/gtm-plan-2026.md` | Full UpSight GTM with budget, calendar, channels | Active (companion) |
| `20-research/market-intel/Keyword-Research/agentcrm-keyword-research.md` | 15 SEO keywords + 7 blog post ideas for AgentCRM | Active (companion) |
| `40-gtm/assets/landing/agentcrm-landing.html` | Landing page with tabbed setup guides | Active |
| `mcp-servers/agent-crm/docs/OPENCLAW-STRATEGY.md` | OpenClaw distribution plan | Partially superseded |
| `30-strategy/docs-platform-evaluation.md` | Mintlify evaluation | Active |
| `30-strategy/icp/user-journeys.md` | Per-persona activation flows | Active (companion) |
