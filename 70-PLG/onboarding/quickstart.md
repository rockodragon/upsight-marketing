...
> **Derived outputs:**
> - Help-center article: `../../marketing-assets/guides/getting-started.md`
...
The activation strategy (`../strategy/activation-strategy.md`) flags **"Never Activated"** as a meaningful cohort needing a "Fresh Start Onboarding" intervention. The walkthroughs in `marketing-assets/scripts/` are for cold-traffic education; this is the in-product / Day-0 path that actually moves a user from signup → first activated call.
