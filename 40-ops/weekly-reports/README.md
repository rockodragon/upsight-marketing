...
Output → `40-ops/weekly-reports/YYYY-MM-DD.md`
...
> "Generate this week's weekly report. Pull open opportunities and research pulse from UpSight MCP. Pull issues from Beads filtered by closed/opened/stuck this week, split by `#build` / `#gtm` label. Read new entries in `00-control/decisions.md` and `40-ops/dogfooding-log.md` since last Friday. Write to `40-ops/weekly-reports/YYYY-MM-DD.md` using the template structure. End with 3-5 suggested focus areas based on the data."
