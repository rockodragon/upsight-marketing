...
- Dogfooding: log friction in `10-ops/dogfooding-log.md` *before* fixing.
...
- `Insights-Business/10-ops/` is the right home for append-only operational narrative (alongside `dogfooding-log.md`, `agents.md`).
