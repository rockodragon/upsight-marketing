...
1. **Cytodyme — close or qualify out.** Demo Wednesday Apr 29. DJ is evaluating as Apollo replacement. Blocker: Recall.ai Electron + Trigger.dev env vars (media sync broken). UpSight opportunity: `b71c41a8`. Every friction point → `10-ops/dogfooding-log.md`. Bead: `Insights-prto`.
