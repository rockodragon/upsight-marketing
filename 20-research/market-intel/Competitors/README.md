...
| [Marvin](./heymarvin.md) | Customer Research Platform | **HIGH** | Unknown, enterprise customers (Microsoft, Honda) | CRM/action layer, cross-functional access, real-time AI interviewer |
...
| [Pylon](./pylon.md) | B2B Support + Post-Sales Intel | Low-Medium | $50M raised (a16z, YC) | Support/CS buyer vs. Research/Product buyer; their Account/Product Intelligence could expand into our space |
