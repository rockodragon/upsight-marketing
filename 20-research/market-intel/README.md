...
**Purpose:** Continuous competitive intelligence and market analysis for UpSight GTM. This is the **external/outward** half of research (the landscape); first-party customer voice lives in `../voice-of-customer/`.

## Folder Structure

```
20-research/market-intel/
├── README.md              # This file
├── Competitors/           # Per-competitor profiles + positioning analysis (incl. Apollo teardown)
...
└── Monthly-Reports/       # Periodic intel reports (YYYY-MM-DD.md)
```
> (Raw stock/investing data that used to live in `Raw-Data/` was moved to `../../_UNSORTED-flagged/` — it wasn't UpSight intel.)

## Relationship to Other Directories

| Directory | Purpose | When to use |
|-----------|---------|-------------|
| **market-intel/** (here) | Ongoing intelligence gathering, competitor monitoring, keyword tracking | Research, analysis, reports |
| **../voice-of-customer/** | First-party customer research: themes, evidence, ICP, surveys | What our users actually say |
| **../../30-strategy/** | Strategic positioning, brand, pricing, GTM plan, personas/ICP | Brand/messaging/strategy decisions |
| **../../40-gtm/** | Execution: campaigns, channels, assets, experiments, PLG | Running campaigns, content, email, analytics |
