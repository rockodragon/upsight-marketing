...
/**
 * CTA scene for the Smart Surveys ad.
 * Tagline: "Smart surveys. Living profiles. Real decisions."
 */
export const SceneCTASmartSurveys: React.FC = () => {
  const logoStyle = useScalePop(10);
  const line1Opacity = useFadeIn(26, 18);
  const line2Opacity = useFadeIn(44, 18);
  const line3Opacity = useFadeIn(60, 18);
  const btnStyle = useSlideUp(72);
  const urlOpacity = useFadeIn(86, 18);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ color: colors.green, opacity: line3Opacity }}>
          Real decisions.
        </div>
      </div>
